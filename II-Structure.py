...
From the given functions and the information you got about the cobra language,
try to answer the following questions.
files: functions.txt
       metabolic_models.pptx
       practical_metabolic_model.docx
...
#22- What is the objective function? Maximized or minimized?
